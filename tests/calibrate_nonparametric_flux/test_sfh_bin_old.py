...
import old_np_mocks as nparams
import numpy as np
import os
...
for i in xrange(1,nbins+1):
	frac_per_bin = np.log10(10**mtot/i)
...
fig.savefig('old_nonparametric_sfh_test.png',dpi=150)
os.system('open old_nonparametric_sfh_test.png')
print 1/0