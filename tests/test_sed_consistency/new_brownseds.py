...
run_params = {'verbose':True,
              'debug': False,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/brownseds_tightbc/brownseds_tightbc',
              'nofork': True,
              # Optimizer params
              'ftol':0.5e-5, 
              'maxfev':5000,
...
fit_order = ['logmass', 'tage', 'logtau', 'dust2', 'delt_trunc', 'sf_tanslope', 'duste_gamma', 'logzsol', 'dust1', 'dust_index','duste_umin', 'duste_qpah']
