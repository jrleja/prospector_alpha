...
#SBATCH -o candels_ir_%a.out
#SBATCH -e candels_ir_%a.err
### Job name
#SBATCH -J 'candels_ir'
...
--param_file="$APPS"/prospector_alpha/parameter_files/candels_ir_params.py \
--objname="$OBJID" \
--outfile="$APPS"/prospector_alpha/results/candels_ir/"$OBJID"