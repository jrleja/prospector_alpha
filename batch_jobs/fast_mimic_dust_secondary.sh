...
### Job name
#SBATCH -J 'fast_mimic_dust_sec'
### output and error logs
#SBATCH -o fast_mimic_dust_sec_%a.out
#SBATCH -e fast_mimic_dust_sec_%a.err
### mail
...
$APPS/prospector_alpha/parameter_files/fast_mimic_dust_params.py \
--objname="$OBJID" \
--overwrite=True \
--plot=False \
--shorten_spec=True
