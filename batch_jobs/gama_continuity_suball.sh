...
### Job name
#SBATCH -J 'gama_continuity'
### output and error logs
#SBATCH -o gama_continuity_%a.out
#SBATCH -e gama_continuity_%a.err
### mail
...
--param_file="$APPS"/prospector_alpha/parameter_files/gama_continuity_params.py \
--objname="$OBJID" \
