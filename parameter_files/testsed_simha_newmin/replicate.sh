...
IDFILE=$APPS"/threedhst_bsfh/data/testsed_simha.ids"
PARAMFOLDER=$APPS"/threedhst_bsfh/parameter_files/testsed_simha_newmin/"
PARAMBASE="testsed_simha_newmin_params"
PARAMEXT=".py"
