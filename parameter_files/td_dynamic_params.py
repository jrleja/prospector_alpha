...
run_params = {'verbose':True,
              'debug': False,
              'outfile': APPS+'/prospector_alpha/results/td_dynamic/COSMOS_1424',
              'nofork': True,
              # dynesty params
...
def load_model(nbins_sfh=7, sigma=0.3, df=2, objname=None, datdir=None, runname=None, agelims=[], zred=None, **extras):
