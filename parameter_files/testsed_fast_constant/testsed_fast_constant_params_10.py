...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/testsed_fast_constant/testsed_fast_constant',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':496,
              'nburn':[32,64,128], 
              ...
              'spec': False, 
              'phot':True,
              'photname':os.getenv('APPS')+'/threedhst_bsfh/data/testsed_constant.cat',
              'truename':os.getenv('APPS')+'/threedhst_bsfh/data/testsed_constant.dat',
              'objname':'10',
              }
