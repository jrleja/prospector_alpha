...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/ha_10myr_longrun/ha_10myr_longrun',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':527,
              'nburn':[32,32,64], 
              ...
              'spec': False, 
              'phot':True,
              'photname':os.getenv('APPS')+'/threedhst_bsfh/data/ha_10myr.cat',
              'truename':os.getenv('APPS')+'/threedhst_bsfh/data/ha_10myr.dat',
              'objname':'52',
              }
