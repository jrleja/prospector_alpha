...
IDFILE=$APPS"/threedhst_bsfh/data/testsed_simha_truth.ids"
PARAMFOLDER=$APPS"/threedhst_bsfh/parameter_files/testsed_simha_truth/"
PARAMBASE="testsed_simha_truth_params"
PARAMEXT=".py"
