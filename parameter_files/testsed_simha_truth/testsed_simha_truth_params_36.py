...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/testsed_simha_truth/testsed_simha_truth',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':496,
              'nburn':[64,64,128], 
...
# set initials to be truths
truths = threed_dutils.load_truths(run_params['truename'],run_params['objname'],None)
for val,name in zip(truths['truths'],truths['parnames']):
    model_params[parmlist.index(name)]['init'] = val
