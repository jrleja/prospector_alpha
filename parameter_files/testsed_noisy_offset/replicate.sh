...
IDFILE=$APPS"/threedhst_bsfh/data/testsed_noisy_offset.ids"
PARAMFOLDER=$APPS"/threedhst_bsfh/parameter_files/testsed_noisy_offset/"
PARAMBASE="testsed_noisy_offset_params"
PARAMEXT=".py"
