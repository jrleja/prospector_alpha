...
run_params = {'verbose':True,
              'debug': False,
              'outfile': os.getenv('APPS')+'/threedhst_bsfh/results/np_mocks_nohersch/np_mocks_nohersch',
              'nofork': True,
              # Optimizer params
              'ftol':0.5e-5, 
              'maxfev':5000,
...
def load_obs(photname='', objname='', **extras):
    ...
    obs['phot_mask'] = np.array([0 if 'herschel' in f else 1 for f in filters],dtype=bool)
    obs['maggies'] = flux
    obs['maggies_unc'] =  unc
    obs['wavelength'] = None
    obs['spectrum'] = None
