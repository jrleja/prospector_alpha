...
run_params = {'verbose':True,
              'debug': False,
              'outfile': os.getenv('APPS')+'/threedhst_bsfh/results/np_mocks_midcr/np_mocks_midcr',
              'nofork': True,
              # Optimizer params
              'ftol':0.5e-5, 
              'maxfev':5000,
              ...
              # Data info
              'photname':os.getenv('APPS')+'/threedhst_bsfh/data/np_mocks_midcr.cat',
              'truename':os.getenv('APPS')+'/threedhst_bsfh/data/np_mocks_midcr.dat',
              'objname':'32'
              }
