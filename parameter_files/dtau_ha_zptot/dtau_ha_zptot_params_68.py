...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/dtau_ha_zptot/dtau_ha_zptot',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':248,
              'nburn':[32,64,128,128], 
              ...
              'spec': False, 
              'phot':True,
              'photname':os.getenv('APPS')+'/threedhst_bsfh/data/COSMOS_testsamp_zp.cat',
              'fastname':os.getenv('APPS')+'/threedhst_bsfh/data/COSMOS_testsamp_zp.fout',
              'ancilname':os.getenv('APPS')+'/threedhst_bsfh/data/COSMOS_testsamp_zp.dat',
              'objname':'5763',
              }
...
obs = threed_dutils.load_obs_3dhst(run_params['photname'], run_params['objname'],
                                    ...
                                    abs_error=run_params['abs_error'], zperr=True)
