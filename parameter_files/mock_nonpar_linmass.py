...
run_params = {'verbose':True,
              'debug': False,
              'outfile': APPS+'/prospector_alpha/results/mock_nonpar_linmass/1',
              'nofork': True,
              # dynesty params
...
model_params.append({'name': 'mass', 'N': 1,
                     ...
                     'init': 1e6,
                     'units': r'M$_\odot$',
                     'prior': priors.TopHat(mini=1e5, maxi=1e12)})
...
fit_order = ['mass', 'logzsol', 'dust2', 'dust_index', 'dust1_fraction']
