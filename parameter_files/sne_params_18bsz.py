...
run_params = {'verbose':True,
              'debug': False,
              'outfile': APPS+'/prospector_alpha/results/sne/SN2018bsz',
              'nofork': True,
              # dynesty params
              ...
              'datfile':APPS+'/prospector_alpha/data/2018bsz-ext.dat',
              'objname':'SN2018bsz'
              }
############
# OBS
...
fit_order = ['massmet','logsfr_ratio30','logsfr_ratiomax','logsfr_ratios', 'dust2', 'dust_index', 'dust1_fraction']
