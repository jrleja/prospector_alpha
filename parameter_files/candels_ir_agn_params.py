...
run_params = {'verbose':True,
              'debug': False,
              'outfile': APPS+'/prospector_alpha/results/candels_ir_agn/21',
              'nofork': True,
              # dynesty params
...
fit_order = ['massmet','logsfr_ratios', 'dust2', 'dust_index', 'dust1_fraction', 'gas_logz','fagn','agn_tau','duste_qpah','duste_umin','duste_gamma']
