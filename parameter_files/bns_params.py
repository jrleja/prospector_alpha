...
run_params = {'verbose':True,
              'debug': False,
              'outfile': os.getenv('APPS')+'/prospector_alpha/results/edo/sne_galaxy',
              # dynesty params
...
fit_order = ['massmet','logsfr_ratios', 'dust2', 'logzsol', 'dust_index', 'dust1_fraction']
...
def load_model(agelims=[],nbins_sfh=13, sigma=0.3, df=2, **extras):
