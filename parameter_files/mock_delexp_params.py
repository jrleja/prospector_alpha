...
run_params = {'verbose':True,
              'debug': False,
              'outfile': APPS+'/prospector_alpha/results/mock_delexp/1',
              'nofork': True,
              # dynesty params
              ...
              'nested_weight_kwargs': {'pfrac': 0.5,'post_thresh':0.04}, # weight posterior and evidence equally
...
def logmass_to_mass(logmass=None,mass=None,**extras):
    return 10**logmass
...
model_params.append({'name': 'logmass', 'N': 1,
                        ...
                        'init': 10.0,
                        'units': 'Msun',
                        'prior': priors.TopHat(mini=8.5, maxi=11.5)})
...
fit_order = ['logmass', 'tage', 'tau', 'logzsol', 'dust2']
