...
IDFILE=$APPS"/threedhst_bsfh/data/virgo/names.txt"
PARAMFOLDER=$APPS"/threedhst_bsfh/parameter_files/virgo/"
PARAMBASE="virgo_params"
PARAMEXT=".py"
...
do
  ...
  sed -ie "s/\'objname\':\'cw4293\'/\'objname\':\'$LINE\'/g" $PARAMFOLDER$PARAMBASE"_$i"$PARAMEXT
