...
run_params = {'verbose':True,
              'debug': False,
              'outfile': APPS+'/prospector_alpha/results/td_new_linexp/AEGIS_13',
              'nofork': True,
              # dynesty params
...
model_params.append({'name': 'tau', 'N': 1,
                        ...
                        'init_disp': 0.5,
                        'units': 'Gyr',
                        'prior': priors.LogUniform(mini=0.03, maxi=100)})
...
fit_order = ['massmet','tage', 'tau', 'dust2', 'dust_index', 'dust1_fraction', 'fagn', 'agn_tau', 'gas_logz']
