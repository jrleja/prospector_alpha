...
IDFILE=$APPS"/threedhst_bsfh/data/testsed_nonoise_fast.ids"
PARAMFOLDER=$APPS"/threedhst_bsfh/parameter_files/testsed_nonoise_fastgen/"
PARAMBASE="testsed_nonoise_fastgen_params"
PARAMEXT=".py"
...
do
  ...
  sed -ie "s/\'objname\':\'1\'/\'objname\':\'$LINE\'/g" $PARAMFOLDER$PARAMBASE"_$i"$PARAMEXT
