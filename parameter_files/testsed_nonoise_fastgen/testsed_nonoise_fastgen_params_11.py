...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/testsed_nonoise_fastgen/testsed_nonoise_fastgen',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':496,
              'nburn':[32,64,128], 
              ...
              'spec': False, 
              'phot':True,
              'photname':os.getenv('APPS')+'/threedhst_bsfh/data/testsed_nonoise_fast.cat',
              'truename':os.getenv('APPS')+'/threedhst_bsfh/data/testsed_nonoise_fast.dat',
              'objname':'11',
              }
