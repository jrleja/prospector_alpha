...
def logtau_to_tau(tau=None, logtau=None, **extras):
    return 10**logtau
...
fit_order = ['massmet','tage', 'tau', 'dust2', 'dust_index', 'dust1_fraction', 'gas_logz','duste_qpah','duste_umin','duste_gamma']
