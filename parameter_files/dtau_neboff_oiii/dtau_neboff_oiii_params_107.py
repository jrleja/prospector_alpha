...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/dtau_neboff_oiii/dtau_neboff_oiii',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':248,
              'nburn':[32,64,128], 
              ...
              'spec': False, 
              'phot':True,
              'photname':os.getenv('APPS')+'/threedhst_bsfh/data/COSMOS_oiii_em.cat',
              'fastname':os.getenv('APPS')+'/threedhst_bsfh/data/COSMOS_oiii_em.fout',
              'ancilname':os.getenv('APPS')+'/threedhst_bsfh/data/COSMOS_oiii_em.dat',
...
halpha_eqw_txt = "%04d" % int(ancildat['OIII_EQW_obs'])
...
print model_params[parmlist.index('sf_start')]['prior_args']['maxi']
print model_params[parmlist.index('tage')]['init']
