...
run_params = {'verbose':True,
              'debug': False,
              'outfile': APPS+'/prospector_alpha/results/gama_continuity_mock/',
              'nofork': True,
              # dynesty params
...
def load_obs(mock_key=None,**extras):
    """ let's rock
    """
    import gama_mock_params
    obs = gama_mock_params.load_obs(mock_key=mock_key)
...
def load_model(objname=None, datloc=None, agelims=[], nbins_sfh=7, sigma=0.3,df=2, **extras):
