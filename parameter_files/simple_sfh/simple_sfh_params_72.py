...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/simple_sfh/simple_sfh',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':496,
              'nburn':[32,32,64], 
              ...
              'spec': False, 
              'phot':True,
              'photname':os.getenv('APPS')+'/threedhst_bsfh/data/simple_sfh.cat',
              'truename':os.getenv('APPS')+'/threedhst_bsfh/data/simple_sfh.dat',
              'objname':'72',
              }
