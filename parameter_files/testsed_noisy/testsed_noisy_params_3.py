...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/testsed_noisy/testsed_noisy',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':248,
              'nburn':[32,64,128,128], 
              ...
              'spec': False, 
              'phot':True,
              'photname':os.getenv('APPS')+'/threedhst_bsfh/data/testsed_noisy.cat',
              'truename':os.getenv('APPS')+'/threedhst_bsfh/data/testsed_noisy.dat',
              'objname':'3',
              }
