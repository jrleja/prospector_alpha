...
run_params = {'verbose':True,
              'outfile':os.getenv('APPS')+'/threedhst_bsfh/results/brownseds_logzsol/brownseds_logzsol',
              'ftol':0.5e-5, 
              'maxfev':5000,
              'nwalkers':496,
              'nburn':[32,32,64], 
...
def translate_filters(bfilters):
    '''
    this has been hacked to bits relative to brownseds_params
    here I will pass a list of FSPS filter names, NOT sorted in effective wavelength
    and I want to return a list of filter names as recognized by my code, in order to
    calculate the proper effective wavelength
    '''
    ...
    inv_map = {v: k for k, v in translate_pfsps.items()}

    brown_version = [inv_map[f] for f in bfilters]
    my_version = [translate[f] for f in brown_version]
