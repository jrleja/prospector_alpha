...
IDFILE=$APPS"/threedhst_bsfh/data/brownseds_logzsol.ids"
PARAMFOLDER=$APPS"/threedhst_bsfh/parameter_files/brownseds_logzsol/"
PARAMBASE="brownseds_logzsol_params"
PARAMEXT=".py"
